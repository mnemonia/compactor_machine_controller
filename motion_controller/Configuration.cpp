...
Configuration::Configuration():
	...
	_heating_upper_upper_temperature_sensor_status(0),
	_heating_upper_lower_temperature_sensor_status(0),
	_heating_lower_upper_temperature_sensor_status(0),
	_heating_lower_lower_temperature_sensor_status(0)
{
...
int  Configuration::get_heating_temperature_sensor_status(int heating_index) {
	switch(heating_index) {
		case 1: {
			return _heating_upper_upper_temperature_sensor_status;
		}
		case 2: {
			return _heating_upper_lower_temperature_sensor_status;
		}
		case 3: {
			return _heating_lower_upper_temperature_sensor_status;
		}
		case 4: {
			return _heating_lower_lower_temperature_sensor_status;
		}
	}
	return 0;
}

void Configuration::set_heating_temperature_sensor_status(int heating_index, int status) {
	switch(heating_index) {
		case 1: {
			_heating_upper_upper_temperature_sensor_status = status;
			break;
		}
		case 2: {
			_heating_upper_lower_temperature_sensor_status = status;
			break;
		}
		case 3: {
			_heating_lower_upper_temperature_sensor_status = status;
			break;
		}
		case 4: {
			_heating_lower_lower_temperature_sensor_status = status;
			break;
		}
	}
}